    ...
    >
      ...
      >
        ...
        <span className="text-accent text-xs flex-1 min-w-0">
          If you&apos;re going through something difficult — you&apos;re not alone.
        </span>
          ...
          >
            <div className="px-4 pb-4 space-y-3">
              <p className="text-text-muted text-xs leading-relaxed">
                We&apos;re praying with you, and we want you to have every support available. These
                organisations are here to listen and help:
              </p>
                ...
                {RESOURCES.map((r) => (
                  <li key={r.name}>
                    ...
                    >
                      ...
                      />
                      <div>
                        <span className="text-accent text-xs group-hover:underline">{r.name}</span>
                        <p className="text-text-dim text-[11px] mt-px">{r.description}</p>
                      </div>
                    </a>
                  </li>
                ))}
