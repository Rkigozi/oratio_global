...
export function UpdatePassword() {
  ...
  if (waitingForSession) {
    return (
      <div
        className="auth-page-scroll flex w-full flex-col items-center justify-center"
  ...
  if (!user && !waitingForSession) {
    return (
      <div
        className="auth-page-scroll flex w-full flex-col items-center justify-center px-6"
        style={{ background: 'rgb(var(--rgb-bg))' }}
      >
        <div className="text-center max-w-sm">
          ...
          <h2 className="font-heading font-light text-xl mb-2 text-text">
    ...
    >
      ...
      <div className="relative z-10 flex flex-col flex-1 justify-center px-6 max-w-sm mx-auto w-full">
        ...
        >
          ...
          <h1
            className="font-heading font-light tracking-[0.2em] text-white mb-3"
            style={{ fontSize: '2rem' }}
          >
