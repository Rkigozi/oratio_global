        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="space-y-4 text-text-muted text-sm leading-relaxed">
            ...
            <section>
              ...
              <p>
                By using Oratio, you agree to these Terms of Service. If you do not agree, please do
            ...
            <section>
              ...
              <p>
                Oratio is a prayer platform that allows users to submit prayer requests, pray for
                others, and engage in supportive community interactions through comments and
                sharing.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                You agree to use Oratio respectfully. Prayer requests and comments should be
                supportive and appropriate for a global Christian community. Harassment, hate
                speech, and harmful content are prohibited and may be reported and removed.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Oratio is provided &quot;as is&quot; without warranty. While we strive to maintain
                the platform, we are not liable for service interruptions or data loss.
              </p>
            </section>
          </div>
        </div>
