...
export function AvatarImage({
  ...
  return (
    <span
      className={`relative inline-flex items-center justify-center overflow-hidden rounded-full bg-accent/10 text-accent ${className}`}
      onClick={onClick}
  ...
  return (
    <>
      {(!imageSrc || failed || !loaded) && (
        <span className="select-none font-semibold uppercase leading-none">
          {initial}
        </span>
      )}
      {imageSrc && !failed && (
