    ...
    <div className="flex flex-col min-h-screen w-full text-[#e8eaf6] relative overflow-hidden" style={{ background: "#0A1A3A" }}>
      ...
      <div className="relative z-10 flex flex-col flex-1 justify-center px-6 max-w-sm mx-auto w-full">
        ...
        >
          ...
          <p className="text-[#6b7499] text-sm">Create your account to begin.</p>
        </motion.div>
        ...
        >
          <div>
            <p className="text-[#6b7499] text-xs uppercase tracking-[0.15em] mb-2 text-center">Email</p>
          ...
          <div>
            <p className="text-[#6b7499] text-xs uppercase tracking-[0.15em] mb-2 text-center">Password</p>
          ...
          <div>
            <p className="text-[#6b7499] text-xs uppercase tracking-[0.15em] mb-2 text-center">Username</p>
