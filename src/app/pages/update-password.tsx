...
export function UpdatePassword() {
  ...
  if (waitingForSession) {
    return (
      <div className="flex flex-col min-h-screen w-full items-center justify-center" style={{ background: "rgb(var(--rgb-bg))" }}>
  ...
  if (!user && !waitingForSession) {
    return (
      <div className="flex flex-col min-h-screen w-full items-center justify-center px-6" style={{ background: "rgb(var(--rgb-bg))" }}>
