-- Keep non-location prayers out of the public map.
-- They can still exist in feeds/profiles, but "Unknown, Unknown" should not
-- create a hotspot at 0,0 or open a location drawer.
