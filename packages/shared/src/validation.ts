...
export const prayerSchema = z.object({
  text: z
    ...
    .trim(),
  location: z.string().max(100, { message: 'Location name too long' }).optional().default(''),
  category: z.string().max(50, { message: 'Category name too long' }).optional(),
...
export const profileSchema = z.object({
  ...
  displayName: z
    ...
    .optional()
    .default(''),
  icon: z.string().max(20, { message: 'Icon selection invalid' }).optional(),
});
